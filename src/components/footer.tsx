    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Transformando empresas con agentes de IA personalizados para la automatización inteligente.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Agentes conversacionales</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Automatización de procesos</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Análisis predictivo</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Consultoría de IA</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            onClick={scrollToTop}
            className="rounded-full p-2 bg-gray-800 hover:bg-gray-700 text-white transition-colors"
